...
const WebPageFooter = () => {
  ...
  const updateWebPageTitle = () => {
    if (location) {
      ...
      else if (pathname === "/user/trains/brand-partner-training") {
        pageTitle = "Brand Partner Trainings"
      }
      else if (pathname === "/user/trains/merchant-training") {
        pageTitle = "Merchant Processing Trainings"
      }
      else if (pathname === "/user/trains/live-training") {
        pageTitle = "Live Trainings Vault"
      }
      else if (pathname === "/user/email-sms/email") {
        pageTitle = "Email"
      }
      else if (pathname === "/user/email-sms/sms") {
        pageTitle = "Sms"
      }
      else if (pathname === "/user/genealogy/business") {
        pageTitle = "Merchants"
      }
      else if (pathname === "/user/genealogy/brand-partner") {
      ...
      else if (pathname === "/user/lead-list") {
        pageTitle = "My Leads"
      }
      /////////////////// admin pages /////////////////////////////////
      else if (pathname === "/admin/training-videos/brand-partner-training") {
        pageTitle = "Brand Partner Trainings"
      }
      else if (pathname === "/admin/training-videos/merchant-training") {
        pageTitle = "Merchant Processing Trainings"
      }
      else if (pathname === "/admin/training-videos/live-training") {
        pageTitle = "Live Trainings Vault"
      }
