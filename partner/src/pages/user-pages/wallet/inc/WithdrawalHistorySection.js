      ...
      },
      {
        ...
        Cell: ({ value, row }) => {
          return <Chip
            ...
            label={value}
            color={
              row.original.transactionStatusType === 'TransactionStatusType_Pending' ? "primary" :
                row.original.transactionStatusType === 'TransactionStatusType_Complete' ? "success" :
                  row.original.transactionStatusType === 'TransactionStatusType_Failed' ? "error" :
                    "error"
            }
          />
        }
