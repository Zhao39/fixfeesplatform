...
import LeadMerchantListTable from './inc/LeadMerchantListTable';
...
const LeadListPage = (props) => {
  ...
  return (
    <PageLayout title="Contacts" cardType="MainCard" cTab={currentTab}>
      <Grid container spacing={0}>
        ...
        <Grid item xs={12} md={12}>
          <div style={{ display: currentTab === TabList[0]['value'] ? 'block' : 'none' }}>
            <LeadMerchantListTable props={props} />
          </div>
          <div style={{ display: currentTab === TabList[1]['value'] ? 'block' : 'none' }}>
            <LeadPartnerListTable props={props} />
          </div>
        </Grid>
      </Grid>
    </PageLayout>
