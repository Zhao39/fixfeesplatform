                              ...
                              <>
                                {
                                  (formData?.license_info?.license_remain_days > 0) ? (
                                    <span>{`Your membership is active, but you have already cancelled (${formData?.license_info?.license_remain_days} day${formData?.license_info?.license_remain_days > 1 ? 's' : ''} left).`}</span>
                                  ) : (
                                    <span>{`Your membership is already cancelled`}</span>
                                  )
                                }
                              </>
                            ) : (
        ...
        (showConfirmModal) ? (
          <>
            <ConfirmDialog
              ...
              title={APP_NAME}
              content={`Are you sure you wish to cancel your membership?`}
              textYes={`Yes`}
              textNo={`No`}
