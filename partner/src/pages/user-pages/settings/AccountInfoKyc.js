...
const AccountInfoKyc = (props) => {
    ...
    const renderKYCStatus = () => {
        const statusText = userInfo?.kyc_status === KYC_STATUS.VERIVIED ? 'Verified' : userInfo?.kyc_status === KYC_STATUS.NOT_VERIVIED ? 'Not verified' : 'Rejected'
        const statusColor = userInfo?.kyc_status === 1 ? 'success' : 'error'
        return (
