...
const UserInfoModal = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        let payload = {
            ...
            tier_commission: form_data.tier_commission
        }
        if (form_data.ref_name) {
            payload = { ...payload, ref_name: formData.ref_name }
        }
        setApiCalling(true)
                    ...
                    <form onSubmit={handleSubmit}>
                        <CardContent sx={{ maxWidth: '100%', width: '600px' }}>
                            <Grid container spacing={3} direction="column">
                                ...
                                <Grid item xs={12} sm={12}>
                                    <Stack spacing={1.25}>
                                        <InputLabel htmlFor="tier_commission">Commission</InputLabel>
                                        <OutlinedInput
                                            fullWidth
                                            id="tier_commission"
                                            value={formData.tier_commission}
                                            name="tier_commission"
                                            onChange={(e) => handleChangeText(e, "tier_commission")}
                                ...
                                <Grid item xs={12} sm={12}>
                                    <Stack spacing={1.25}>
                                        <InputLabel htmlFor="ref_name">Sponsor</InputLabel>
                                        <OutlinedInput
                                            fullWidth
                                            id="ref_name"
                                            value={formData.ref_name}
                                            name="ref_name"
                                            onChange={(e) => handleChangeText(e, "ref_name")}
