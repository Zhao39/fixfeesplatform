      ...
      <Grid container spacing={6}>
        <Grid item xs={12}>
          ...
          <Stack spacing={2.5} alignItems="center">
            ...
            />
            <Stack spacing={0.5} alignItems="center">
              <Typography variant="h5">Ortfelia</Typography>
            </Stack>
        ...
        <Grid item xs={12} sm={6} md={12}>
          <Stack direction="row" justifyContent="space-around" alignItems="center">
            <Stack spacing={0.5} alignItems="center">
              ...
              <Typography color="secondary">ADS</Typography>
            </Stack>
            <Divider orientation="vertical" flexItem />
            <Stack spacing={0.5} alignItems="center">
              <Typography variant="h5">4000</Typography>
              <Typography color="secondary">Sales</Typography>
            </Stack>
            <Divider orientation="vertical" flexItem />
            <Stack spacing={0.5} alignItems="center">
              <Typography variant="h5">4.5K</Typography>
              <Typography color="secondary">ROAS</Typography>
            </Stack>
          </Stack>
        </Grid>
        <Grid item xs={12}>
