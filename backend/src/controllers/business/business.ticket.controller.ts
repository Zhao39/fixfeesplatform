...
import { console_log, empty, get_data_value, get_message_template, get_utc_timestamp, intval, isset, mail_attachment } from '../../helpers/misc';
...
export default class BusinessTicketController extends BusinessBaseController {
  constructor() {
    super();
  }
...
export const businessTicketController = new BusinessTicketController()
