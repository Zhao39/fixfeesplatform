...
import { TB_BUSINESS_ADMIN } from "../var/tables";
import { BaseService } from "./base.service";
import { DEFAULT_PASSWORD } from "../var/config";

export default class BusinessAdminService extends BaseService {
  constructor() {
    super();
    this.tableName = TB_BUSINESS_ADMIN;
  }

  /**
   * check if business admin login is correct
   */
...
export const businessAdminService = new BusinessAdminService();
