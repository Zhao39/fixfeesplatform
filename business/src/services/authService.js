...
import { urlApplyMembershipCoupon, urlCheckCoupon, urlCheckCouponSecurity, urlCheckEmailVerified, urlCheckSponsor, urlCompleteRegister, urlConfirmEmailVerification, urlGetRegistraterPageData, urlLogin, urlLoginTwoFactAuth, urlLogout, urlRegistraterBusiness, urlResendConfirmEmail, urlResetPassword, urlSaveRegisterBillingInfo, urlSaveRegistraterBillPlan, urlSaveRegistraterDetail, urlSaveRegistraterEmail, urlSendConfirmEmail, urlSendForgotPasswordEmail } from "./constants";
...
export const apiRegistraterBusiness = async (business_info, files = null) => { // register for business
  const url = urlRegistraterBusiness;
  var formData = new FormData();
