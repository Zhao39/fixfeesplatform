...
const ColorScheme = () => {
  ...
  const colorOptions = [
    ...
    {
      id: 'theme3',
      primary: mode === 'dark' ? PRIMARY_COLOR : PRIMARY_COLOR,
      lighter: mode === 'dark' ? PRIMARY_COLOR : PRIMARY_COLOR,
      label: 'Theme 3',
      shadow: `0 0 0 2px ${alpha(mode === 'dark' ? PRIMARY_COLOR : PRIMARY_COLOR, 0.2)}`
    },
    {
      id: 'theme4',
