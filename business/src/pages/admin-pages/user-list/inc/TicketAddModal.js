...
import { apiAdminSubmitTicket } from 'services/adminTicketService';
...
const TicketAddModal = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setApiCalling(true)
        const apiRes = await apiAdminSubmitTicket(payload, uploadFile)
        setApiCalling(false)
        if (apiRes['status'] === '1') {
            ...
            // let redirectUrl = "/admin/ticket?id=" + ticketid
            // setTimeout(() => {
            //   history(redirectUrl)
            // }, 100)
