...
const WithdrawalModal = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            paypal_address: form_data.paypal_address
        }
        setApiCalling(true)
                    ...
                    <form onSubmit={handleSubmit}>
                        <CardContent sx={{ maxWidth: '100%', width: '600px' }}>
                            <Grid container spacing={3} direction="column">
                                ...
                                <Grid item xs={12} sm={12}>
                                    <Stack spacing={1.25}>
                                        <InputLabel htmlFor="paypal_address">Your PayPal Email</InputLabel>
                                        <OutlinedInput
                                            fullWidth
                                            id="paypal_address"
                                ...
                                <Grid item xs={12} sm={12}>
                                    <Stack spacing={1.25}>
                                        <InputLabel htmlFor="paypal_address">Confirm Your PayPal Email</InputLabel>
                                        <OutlinedInput
                                            fullWidth
                                            id="paypal_address_c"
                                ...
                                <Grid item xs={12} sm={12}>
                                    <Alert color="warning" variant="border" icon={<WarningFilled />}>
                                        <AlertTitle > Please make sure you provide us with the correct PayPal email address so your funds can arrive as soon as possible.</AlertTitle>
                                    </Alert>
                                </Grid>
